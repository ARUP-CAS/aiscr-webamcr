...
**Skill body (authoritative):** [`.claude/skills/aiscr-ci-scriptification/SKILL.md`](.claude/skills/aiscr-ci-scriptification/SKILL.md) — load that repository-local file for the full workflow body, guardrails, and verification.
