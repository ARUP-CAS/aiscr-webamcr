...
**Route**: Load [`.claude/skills/aiscr-canonical-workflows-context/SKILL.md`](.claude/skills/aiscr-canonical-workflows-context/SKILL.md) for the full workflow body, guardrails, and steps, then follow the instructions there.

**Full reader**: [`.cursor/skills/aiscr-canonical-workflows-context/SKILL.md`](.cursor/skills/aiscr-canonical-workflows-context/SKILL.md) when Cursor reader body is preferred.

`.agents/plans/canonical-workflows-context.plan.md`
Read canonical_workflows_context.md directly and load listed context in order.
