...
ALTER TABLE akce_vedouci ADD CONSTRAINT akce_vedouci_vedouci_fk FOREIGN KEY (vedouci) REFERENCES osoba (id) ON UPDATE CASCADE ON DELETE NO ACTION;
ALTER TABLE adb ADD CONSTRAINT archeologicky_dokumentacni_bod_autor_popisu_fkey FOREIGN KEY (autor_popisu) REFERENCES osoba (id) ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE adb ADD CONSTRAINT archeologicky_dokumentacni_bod_autor_revize_fkey FOREIGN KEY (autor_revize) REFERENCES osoba (id) ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE adb ADD CONSTRAINT archeologicky_dokumentacni_bod_parent_fkey FOREIGN KEY (dokumentacni_jednotka) REFERENCES dokumentacni_jednotka (id) ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE adb_sekvence ADD CONSTRAINT archeologicky_dokumentacni_bod_sekvence_kladysm5_id_fkey FOREIGN KEY (kladysm5_id) REFERENCES kladysm5 (gid) ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE auth_user ADD CONSTRAINT auth_user_hlavni_role FOREIGN KEY (hlavni_role) REFERENCES auth_group (id) ON UPDATE CASCADE ON DELETE NO ACTION;
...
ALTER TABLE dokument_autor ADD CONSTRAINT dokument_autor_autor_fk FOREIGN KEY (autor) REFERENCES osoba (id) ON UPDATE CASCADE ON DELETE NO ACTION;
  --
  --
  --
  --
  --
ALTER TABLE dokument_osoba ADD CONSTRAINT dokument_autor_autor_fk FOREIGN KEY (osoba) REFERENCES osoba (id) ON UPDATE CASCADE ON DELETE NO ACTION;
   --
ALTER TABLE dokument_autor ADD CONSTRAINT dokument_autor_dokument_fk FOREIGN KEY (dokument) REFERENCES dokument (id) ON UPDATE CASCADE ON DELETE CASCADE;
   --
   --
   --
ALTER TABLE dokument_osoba ADD CONSTRAINT dokument_autor_dokument_fk FOREIGN KEY (dokument) REFERENCES dokument (id) ON UPDATE CASCADE ON DELETE CASCADE;
  --
  --
  --
  --
...
ALTER TABLE dokument_jazyk ADD CONSTRAINT dokument_jazyk_dokument_fk FOREIGN KEY (dokument) REFERENCES dokument (id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE dokument_posudek ADD CONSTRAINT dokument_posudek_dokument_fk FOREIGN KEY (dokument) REFERENCES dokument (id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE externi_zdroj_autor ADD CONSTRAINT externi_zdroj_autor_autor_fk FOREIGN KEY (autor) REFERENCES osoba (id) ON UPDATE CASCADE ON DELETE NO ACTION;
ALTER TABLE externi_zdroj_autor ADD CONSTRAINT externi_zdroj_autor_externi_zdroj_fk FOREIGN KEY (externi_zdroj) REFERENCES externi_zdroj (id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE externi_zdroj_editor ADD CONSTRAINT externi_zdroj_editor_editor_fk FOREIGN KEY (editor) REFERENCES osoba (id) ON UPDATE CASCADE ON DELETE NO ACTION;
ALTER TABLE externi_zdroj_editor ADD CONSTRAINT externi_zdroj_editor_externi_zdroj_fk FOREIGN KEY (externi_zdroj) REFERENCES externi_zdroj (id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE dokument_extra_data ADD CONSTRAINT extra_data_dokument_fkey FOREIGN KEY (dokument) REFERENCES dokument (id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE dokument_cast ADD CONSTRAINT jednotka_dokument_dokument_fkey FOREIGN KEY (dokument) REFERENCES dokument (id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE ruian_katastr ADD CONSTRAINT katastr_storage_okres_fkey FOREIGN KEY (okres) REFERENCES ruian_okres (id) ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE ruian_katastr ADD CONSTRAINT katastr_storage_pian_fkey FOREIGN KEY (pian) REFERENCES pian (id) ON UPDATE CASCADE ON DELETE SET NULL;
ALTER TABLE ruian_katastr ADD CONSTRAINT katastr_storage_soucasny_fkey FOREIGN KEY (soucasny) REFERENCES ruian_katastr (id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE komponenta_aktivita ADD CONSTRAINT komponenta_aktivita_komponenta_fk FOREIGN KEY (komponenta) REFERENCES komponenta (id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE neident_akce_vedouci ADD CONSTRAINT neident_akce_vedouci_neident_akce_fk FOREIGN KEY (neident_akce) REFERENCES neident_akce (id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE neident_akce_vedouci ADD CONSTRAINT neident_akce_vedouci_vedouci_fk FOREIGN KEY (vedouci) REFERENCES osoba (id) ON UPDATE CASCADE ON DELETE NO ACTION;
...
ALTER TABLE projekt_oznameni_suffix ADD CONSTRAINT project_announcement_suffix_project_id_fkey FOREIGN KEY (project_id) REFERENCES projekt (id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE projekt_katastr ADD CONSTRAINT projekt_katastr_katastr_fk FOREIGN KEY (katastr_id) REFERENCES ruian_katastr (id) ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE projekt_katastr ADD CONSTRAINT projekt_katastr_projekt_fk FOREIGN KEY (projekt_id) REFERENCES projekt (id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE projekt ADD CONSTRAINT projekt_vedouci_vyzkumu_fkey FOREIGN KEY (vedouci_projektu) REFERENCES osoba (id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE samostatny_nalez ADD CONSTRAINT samostany_nalez_organizace_fkey FOREIGN KEY (predano_organizace) REFERENCES organizace (id) ON UPDATE CASCADE ON DELETE NO ACTION;
ALTER TABLE samostatny_nalez ADD CONSTRAINT samostany_nalez_projekt_fkey FOREIGN KEY (projekt) REFERENCES projekt (id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE uzivatel ADD CONSTRAINT user_storage_historie_fkey FOREIGN KEY (historie) REFERENCES historie_vazby (id) ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE uzivatel_spoluprace ADD CONSTRAINT vazba_spoluprace_historie_fkey FOREIGN KEY (historie) REFERENCES historie_vazby (id) ON UPDATE CASCADE ON DELETE SET NULL;
