...
CREATE SEQUENCE externi_zdroj_editor_id_seq;  alter table externi_zdroj_editor drop constraint externi_zdroj_editor_pkey;
...
CREATE SEQUENCE heslar_hierarchie_id_seq;  alter table heslar_hierarchie drop constraint heslar_hierarchie_pkey;
...
ALTER TABLE neident_akce  DROP CONSTRAINT neident_akce_pkey;    ALTER TABLE neident_akce DROP COLUMN puvodni_id; DROP SEQUENCE neident_akce_id_seq;
...
CREATE SEQUENCE neident_akce_vedouci_id_seq;  alter table neident_akce_vedouci drop constraint neident_akce_vedouci_pkey;
...
CREATE SEQUENCE notifikace_projekt_id_seq;  ALTER TABLE notifikace_projekt ADD COLUMN id integer NOT NULL DEFAULT nextval('notifikace_projekt_id_seq'::regclass) PRIMARY KEY;
