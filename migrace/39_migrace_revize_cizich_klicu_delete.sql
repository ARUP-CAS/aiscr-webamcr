...
ALTER TABLE dokument_osoba DROP CONSTRAINT dokument_autor_autor_fk;
ALTER TABLE dokument_osoba DROP CONSTRAINT dokument_autor_autor_fk;
ALTER TABLE dokument_autor DROP CONSTRAINT dokument_autor_dokument_fkey;
...
ALTER TABLE dokument_jazyk DROP CONSTRAINT dokument_jazyk_dokument_fkey;
...
ALTER TABLE dokument_posudek DROP CONSTRAINT dokument_posudek_dokument_fkey;
...
ALTER TABLE externi_zdroj_autor DROP CONSTRAINT externi_zdroj_autor_autor_fkey;
ALTER TABLE externi_zdroj_autor DROP CONSTRAINT externi_zdroj_autor_externi_zdroj_fkey;
ALTER TABLE externi_zdroj_editor DROP CONSTRAINT externi_zdroj_editor_editor_fk;
ALTER TABLE externi_zdroj_editor DROP CONSTRAINT externi_zdroj_editor_externi_zdroj_fkey;
...
ALTER TABLE komponenta_aktivita DROP CONSTRAINT komponenta_aktivita_komponenta_fkey;
...
ALTER TABLE projekt_katastr DROP CONSTRAINT projekt_katastr_projekt_fkey;
