...
select id, 1 as nazev_heslare, nazev, en, poradi, zkratka from heslar_aktivity                   union
select id, 2 as nazev_heslare, nazev, en, poradi, null from heslar_areal_druha                union
select id, 3 as nazev_heslare, nazev, en, poradi, null from heslar_areal_prvni                union
select id, 4 as nazev_heslare, nazev, en, null, zkratka from heslar_autorska_role              union
select id, 5 as nazev_heslare, nazev, en, poradi, null from heslar_dohlednost                 union
select id, 6 as nazev_heslare, nazev, en, poradi, null from heslar_druh_lokality_druha        union
select id, 7 as nazev_heslare, nazev, en, poradi, null from heslar_druh_lokality_prvni        union
select id, 8 as nazev_heslare, nazev, en, poradi, null from heslar_format_dokumentu           union
select id, 9 as nazev_heslare, null, en, poradi, nazev from heslar_jazyk_dokumentu            union
select id, 10 as nazev_heslare, nazev, en, poradi, null from heslar_kulturni_pamatka           union
select id, 11 as nazev_heslare, nazev, en, poradi, null from heslar_letiste                    union
select id, 12 as nazev_heslare, nazev, en, poradi, null from heslar_material_dokumentu         union
select id, 13 as nazev_heslare, null, en, poradi, nazev from heslar_nahrada                    union
select id, 14 as nazev_heslare, nazev, en, poradi, null from heslar_nalezove_okolnosti         union
select id, 15 as nazev_heslare, nazev, en, poradi, zkratka from heslar_obdobi_druha               union
select id, 16 as nazev_heslare, nazev, en, poradi, null from heslar_obdobi_prvni               union
select id, 17 as nazev_heslare, nazev, en, poradi, null from heslar_objekt_druh                union
select id, 18 as nazev_heslare, nazev, en, poradi, null from heslar_objekt_kategorie           union
select id, 19 as nazev_heslare, nazev, en, poradi, null from heslar_pocasi                     union
select id, 20 as nazev_heslare, nazev, en, poradi, null from heslar_podnet                     union
select id, 21 as nazev_heslare, nazev, en, poradi, null from heslar_posudek                    union
select id, 22 as nazev_heslare, nazev, en, poradi, null from heslar_predmet_druh               union
select id, 23 as nazev_heslare, nazev, en, poradi, null from heslar_predmet_kategorie          union
...
select id, 28 as nazev_heslare, nazev, en, poradi, null from heslar_specifikace_objektu_druha  union
select id, 29 as nazev_heslare, nazev, en, poradi, null from heslar_specifikace_objektu_prvni  union
select id, 30 as nazev_heslare, nazev, en, poradi, null from heslar_specifikace_predmetu       union
select id, 31 as nazev_heslare, nazev, en, poradi, null from heslar_tvar                       union
select id, 32 as nazev_heslare, nazev, en, poradi, null from heslar_typ_akce_druha             union
select id, 33 as nazev_heslare, nazev, en, poradi, null from heslar_typ_akce_prvni             union
...
select id, 39 as nazev_heslare, nazev, en, poradi, null from heslar_typ_organizace             union
...
select id, 42 as nazev_heslare, nazev, en, poradi, null from heslar_typ_sondy                  union
select id, 43 as nazev_heslare, nazev, en, poradi, null from heslar_typ_udalosti               union
select id, 44 as nazev_heslare, nazev, en, poradi, null from heslar_typ_vyskovy_bod            union
select id, 45 as nazev_heslare, nazev, en, poradi, null from heslar_ulozeni_originalu          union
select id, 46 as nazev_heslare, null, en, poradi, nazev from heslar_zachovalost                union
select id, 47 as nazev_heslare, nazev, nazev_en, poradi, kod from heslar_zeme order by nazev_heslare;
...
update nalez set specifikace = sel.new_id from (select id as new_id, puvodni_id as puvodni from heslar where nazev_heslare = 28) sel where specifikace = sel.puvodni;
update nalez set specifikace = sel.new_id from (select id as new_id, puvodni_id as puvodni from heslar where nazev_heslare = 30) sel where specifikace = sel.puvodni;
