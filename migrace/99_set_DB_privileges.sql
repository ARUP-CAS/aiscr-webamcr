...
REVOKE ALL ON amcr_geom_migrations_jobs FROM cz_archeologickamapa_api, cz_archeologickamapa_api_view;
REVOKE ALL ON amcr_geom_migrations_jobs_sjtsk_errors FROM cz_archeologickamapa_api, cz_archeologickamapa_api_view;
REVOKE ALL ON amcr_geom_migrations_jobs_wgs84_errors FROM cz_archeologickamapa_api, cz_archeologickamapa_api_view;
...
REVOKE ALL ON auth_group_permissions FROM cz_archeologickamapa_api, cz_archeologickamapa_api_view;
REVOKE ALL ON auth_permission FROM cz_archeologickamapa_api, cz_archeologickamapa_api_view;
...
REVOKE ALL ON auth_user_user_permissions FROM cz_archeologickamapa_api, cz_archeologickamapa_api_view;
REVOKE ALL ON django_admin_log FROM cz_archeologickamapa_api, cz_archeologickamapa_api_view;
REVOKE ALL ON django_celery_beat_clockedschedule FROM cz_archeologickamapa_api, cz_archeologickamapa_api_view;
REVOKE ALL ON django_celery_beat_crontabschedule FROM cz_archeologickamapa_api, cz_archeologickamapa_api_view;
REVOKE ALL ON django_celery_beat_intervalschedule FROM cz_archeologickamapa_api, cz_archeologickamapa_api_view;
REVOKE ALL ON django_celery_beat_periodictask FROM cz_archeologickamapa_api, cz_archeologickamapa_api_view;
REVOKE ALL ON django_celery_beat_periodictasks FROM cz_archeologickamapa_api, cz_archeologickamapa_api_view;
REVOKE ALL ON django_celery_beat_solarschedule FROM cz_archeologickamapa_api, cz_archeologickamapa_api_view;
REVOKE ALL ON django_celery_results_chordcounter FROM cz_archeologickamapa_api, cz_archeologickamapa_api_view;
REVOKE ALL ON django_celery_results_groupresult FROM cz_archeologickamapa_api, cz_archeologickamapa_api_view;
REVOKE ALL ON django_celery_results_taskresult FROM cz_archeologickamapa_api, cz_archeologickamapa_api_view;
REVOKE ALL ON django_content_type FROM cz_archeologickamapa_api, cz_archeologickamapa_api_view;
REVOKE ALL ON django_cron_cronjoblock FROM cz_archeologickamapa_api, cz_archeologickamapa_api_view;
REVOKE ALL ON django_cron_cronjoblog FROM cz_archeologickamapa_api, cz_archeologickamapa_api_view;
REVOKE ALL ON django_migrations FROM cz_archeologickamapa_api, cz_archeologickamapa_api_view;
REVOKE ALL ON django_session FROM cz_archeologickamapa_api, cz_archeologickamapa_api_view;
...
REVOKE ALL ON notifikace_log FROM cz_archeologickamapa_api, cz_archeologickamapa_api_view;
...
GRANT SELECT ON amcr_geom_migrations_jobs TO cz_archeologickamapa_api_view;
GRANT SELECT ON amcr_geom_migrations_jobs_sjtsk_errors TO cz_archeologickamapa_api_view;
GRANT SELECT ON amcr_geom_migrations_jobs_wgs84_errors TO cz_archeologickamapa_api_view;
...
GRANT SELECT ON auth_group_permissions TO cz_archeologickamapa_api_view;
GRANT SELECT ON auth_permission TO cz_archeologickamapa_api_view;
...
GRANT SELECT ON auth_user_user_permissions TO cz_archeologickamapa_api_view;
GRANT SELECT ON django_admin_log TO cz_archeologickamapa_api_view;
GRANT SELECT ON django_celery_beat_clockedschedule TO cz_archeologickamapa_api_view;
GRANT SELECT ON django_celery_beat_crontabschedule TO cz_archeologickamapa_api_view;
GRANT SELECT ON django_celery_beat_intervalschedule TO cz_archeologickamapa_api_view;
GRANT SELECT ON django_celery_beat_periodictask TO cz_archeologickamapa_api_view;
GRANT SELECT ON django_celery_beat_periodictasks TO cz_archeologickamapa_api_view;
GRANT SELECT ON django_celery_beat_solarschedule TO cz_archeologickamapa_api_view;
GRANT SELECT ON django_celery_results_chordcounter TO cz_archeologickamapa_api_view;
GRANT SELECT ON django_celery_results_groupresult TO cz_archeologickamapa_api_view;
GRANT SELECT ON django_celery_results_taskresult TO cz_archeologickamapa_api_view;
GRANT SELECT ON django_content_type TO cz_archeologickamapa_api_view;
GRANT SELECT ON django_cron_cronjoblock TO cz_archeologickamapa_api_view;
GRANT SELECT ON django_cron_cronjoblog TO cz_archeologickamapa_api_view;
GRANT SELECT ON django_migrations TO cz_archeologickamapa_api_view;
GRANT SELECT ON django_session TO cz_archeologickamapa_api_view;
...
GRANT SELECT ON notifikace_log TO cz_archeologickamapa_api_view;
...
GRANT ALL ON amcr_geom_migrations_jobs TO cz_archeologickamapa_api;
GRANT ALL ON amcr_geom_migrations_jobs_sjtsk_errors TO cz_archeologickamapa_api;
GRANT ALL ON amcr_geom_migrations_jobs_wgs84_errors TO cz_archeologickamapa_api;
...
GRANT ALL ON auth_group_permissions TO cz_archeologickamapa_api;
GRANT ALL ON auth_permission TO cz_archeologickamapa_api;
...
GRANT ALL ON auth_user_user_permissions TO cz_archeologickamapa_api;
GRANT ALL ON django_admin_log TO cz_archeologickamapa_api;
GRANT ALL ON django_celery_beat_clockedschedule TO cz_archeologickamapa_api;
GRANT ALL ON django_celery_beat_crontabschedule TO cz_archeologickamapa_api;
GRANT ALL ON django_celery_beat_intervalschedule TO cz_archeologickamapa_api;
GRANT ALL ON django_celery_beat_periodictask TO cz_archeologickamapa_api;
GRANT ALL ON django_celery_beat_periodictasks TO cz_archeologickamapa_api;
GRANT ALL ON django_celery_beat_solarschedule TO cz_archeologickamapa_api;
GRANT ALL ON django_celery_results_chordcounter TO cz_archeologickamapa_api;
GRANT ALL ON django_celery_results_groupresult TO cz_archeologickamapa_api;
GRANT ALL ON django_celery_results_taskresult TO cz_archeologickamapa_api;
GRANT ALL ON django_content_type TO cz_archeologickamapa_api;
GRANT ALL ON django_cron_cronjoblock TO cz_archeologickamapa_api;
GRANT ALL ON django_cron_cronjoblog TO cz_archeologickamapa_api;
GRANT ALL ON django_migrations TO cz_archeologickamapa_api;
GRANT ALL ON django_session TO cz_archeologickamapa_api;
...
GRANT ALL ON notifikace_log TO cz_archeologickamapa_api;
