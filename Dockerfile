FROM node:26-bookworm-slim AS node-modules
...
FROM ghcr.io/osgeo/gdal:ubuntu-small-3.13.2 AS python-builder
...
FROM ghcr.io/osgeo/gdal:ubuntu-small-3.13.2 AS runtime
