...
.. py:function:: soubor_get_rozsah(sender, instance)
   ...
   **Parametry:**
   ...
   - ``sender``: Model ``Soubor``, který signál vyslal.
   - ``instance``: Instancia ``Soubor`` předaná k uložení.
   - ``kwargs``: Dodatečné argumenty signálu.
...
.. py:function:: soubor_save_update_record_metadata(sender, instance)
   ...
   **Parametry:**
   ...
   - ``sender``: Model ``Soubor``, který signál vyslal.
   - ``instance``: Instancia ``Soubor`` která byla uložena.
   - ``kwargs``: Dodatečné argumenty signálu.
...
.. py:function:: soubor_delete_connections(sender, instance)
   ...
   **Parametry:**
   ...
   - ``sender``: Model ``Soubor``, který signál vyslal.
   - ``instance``: Instancia ``Soubor`` určená ke smazání.
   - ``kwargs``: Dodatečné argumenty signálu.
...
.. py:function:: soubor_delete_update_metadata(sender, instance)
   ...
   **Parametry:**
   ...
   - ``sender``: Model ``Soubor``, který signál vyslal.
   - ``instance``: Instancia ``Soubor`` která byla smazána.
   - ``kwargs``: Dodatečné argumenty signálu.
