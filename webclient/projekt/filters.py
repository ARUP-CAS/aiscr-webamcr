        ...
        self.layout = Layout(
            Div(
                Div(
                    ...
                    Div("typ_projektu", css_class="col-sm-6 col-lg-2"),
                    Div("stav", css_class="col-sm-6 col-lg-2"),
                    Div("organizace", css_class="col-sm-6 col-lg-2"),
                    Div("vedouci_projektu", css_class="col-sm-6 col-lg-2"),
                    Div("kulturni_pamatka", css_class="col-sm-6 col-lg-2"),
                    ...
                    Div("planovane_zahajeni", css_class="col-sm-6 col-lg-4 app-daterangepicker"),
                    ...
                    Div("termin_odevzdani_nz", css_class="col-sm-6 col-lg-4 app-daterangepicker"),
                    Div("pristupnost_snapshot", css_class="col-sm-6 col-lg-2"),
                    css_class="row",
                ),
                Div(
                ...
                Div(
                    Div("akce_ident_obsahuje", css_class="col-sm-6 col-lg-2"),
                    Div("typ_akce", css_class="col-sm-6 col-lg-2"),
                    Div("stav_akce", css_class="col-sm-6 col-lg-2"),
                    Div("akce_vedouci_organizace", css_class="col-sm-6 col-lg-2"),
                    Div("akce_vedouci", css_class="col-sm-6 col-lg-2"),
                    Div("pristupnost_akce", css_class="col-sm-6 col-lg-2"),
                    Div("akce_katastr", css_class="col-sm-6 col-lg-2"),
                    Div("akce_okres", css_class="col-sm-6 col-lg-2"),
                    Div("akce_kraj", css_class="col-sm-6 col-lg-2"),
                    Div("akce_popisne_udaje", css_class="col-sm-6 col-lg-6"),
                    Div("akce_datum_zahajeni", css_class="col-sm-6 col-lg-4 app-daterangepicker"),
                    Div("akce_datum_ukonceni", css_class="col-sm-6 col-lg-4 app-daterangepicker"),
                    Div("akce_zjisteni", css_class="col-sm-6 col-lg-2"),
                    Div("akce_je_nz", css_class="col-sm-6 col-lg-2"),
                    id="akcieCollapse",
                    css_class="collapse row",
                ),
                Div(
                ...
                Div(
                    Div("dokument_ident_obsahuje", css_class="col-sm-6 col-lg-2"),
                    Div("pian_ident_obsahuje", css_class="col-sm-6 col-lg-2"),
                    Div("zdroj_ident_obsahuje", css_class="col-sm-6 col-lg-2"),
