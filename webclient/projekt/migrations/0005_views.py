...
class Migration(migrations.Migration):
    ...
    """Zapouzdřuje chování třídy ``Migration`` pro modul ``webclient.projekt.migrations.0005_views``."""
    initial = True
    ...
    operations = [
        migrations.RunSQL(
            ...
            CREATE MATERIALIZED VIEW amcr_heat_projekt_l2 as select count(*) as count, geom as st_centroid from amcr_heat_projekt_l1 where ST_IsEmpty(geom) = false group by st_centroid having count(*) > 1;
            """,
            reverse_sql="""
