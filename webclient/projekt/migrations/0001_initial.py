    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('historie', models.ForeignKey(db_column='historie', on_delete=django.db.models.deletion.DO_NOTHING, to='historie.historievazby')),
                ('hlavni_katastr', models.ForeignKey(blank=True, db_column='hlavni_katastr', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='projekty_hlavnich_katastru', to='heslar.ruiankatastr', verbose_name='Hlavní katastry')),
            ],
            options={
