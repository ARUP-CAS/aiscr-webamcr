...
class ProjektZapsatSeleniumTest(BaseSeleniumTestClass):
    """Zapouzdřuje chování třídy ``ProjektZapsatSeleniumTest`` pro modul ``webclient.projekt.tests.test_selenium``."""
    def ProjektZapsat(
...
class ProjektArchivovatSeleniumTest(BaseSeleniumTestClass):
    """Zapouzdřuje chování třídy ``ProjektArchivovatSeleniumTest`` pro modul ``webclient.projekt.tests.test_selenium``."""
...
class ProjektZrusitSeleniumTest(BaseSeleniumTestClass):
    ...
    """Zapouzdřuje chování třídy ``ProjektZrusitSeleniumTest`` pro modul ``webclient.projekt.tests.test_selenium``."""
