        ...
        self.layout = Layout(
            Div(
                Div(
                    ...
                    Div("igsn", css_class="col-sm-6 col-lg-2"),
                    Div("typ_lokality", css_class="col-sm-6 col-lg-2"),
                    Div("druh_lokality", css_class="col-sm-6 col-lg-2"),
                    Div("zachovalost_lokality", css_class="col-sm-6 col-lg-2"),
                    Div("jistota_lokality", css_class="col-sm-6 col-lg-2"),
