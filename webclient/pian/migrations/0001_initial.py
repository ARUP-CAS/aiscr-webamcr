...
class Migration(migrations.Migration):
    ...
    """Zapouzdřuje chování třídy ``Migration`` pro modul ``webclient.pian.migrations.0001_initial``."""
    initial = True
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('geom', django.contrib.gis.db.models.fields.GeometryField(srid=4326, db_index=True)),
                ('geom_sjtsk', django.contrib.gis.db.models.fields.GeometryField(blank=True, null=True, srid=5514, db_index=True)),
                ('geom_system', models.CharField(default="4326", max_length=6, db_index=True)),
                ('ident_cely', models.CharField(unique=True, max_length=13)),
                ('stav', models.SmallIntegerField(choices=[(1, "pian.models.pian.states.nepotvrzen"), (2, "pian.models.pian.states.potvrzen")], default=1, db_index=True)),
