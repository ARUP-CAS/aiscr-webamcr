    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('presnost', models.ForeignKey(db_column='presnost', limit_choices_to={'nazev_heslare': 24}, on_delete=django.db.models.deletion.DO_NOTHING, related_name='piany_presnosti', to='heslar.heslar')),
