    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nazev_en', models.TextField(blank=True, verbose_name='heslar.models.RuianOkres.nazev_en')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hranice', django.contrib.gis.db.models.fields.GeometryField(srid=4326, verbose_name='heslar.models.RuianKatastr.hranice')),
                ('nazev_stary', models.TextField(blank=True, null=True, verbose_name='heslar.models.RuianKatastr.nazev_stary')),
                ('pian', models.IntegerField(unique=True, verbose_name='heslar.models.RuianKatastr.pian')),
