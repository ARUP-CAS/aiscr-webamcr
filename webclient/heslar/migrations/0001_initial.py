    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dokument_material', models.ForeignKey(db_column='dokument_material', on_delete=django.db.models.deletion.DO_NOTHING, related_name='material', to='heslar.heslar')),
                ('dokument_rada', models.ForeignKey(db_column='dokument_rada', on_delete=django.db.models.deletion.DO_NOTHING, related_name='rada', to='heslar.heslar')),
                ('dokument_typ', models.ForeignKey(db_column='dokument_typ', on_delete=django.db.models.deletion.DO_NOTHING, related_name='typ', to='heslar.heslar')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('heslo_podrazene', models.OneToOneField(db_column='heslo_podrazene', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, related_name='podrazene', serialize=False, to='heslar.heslar')),
