...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Adb',
            fields=[
                ('dokumentacni_jednotka', models.OneToOneField(db_column='dokumentacni_jednotka', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='dj.dokumentacnijednotka')),
