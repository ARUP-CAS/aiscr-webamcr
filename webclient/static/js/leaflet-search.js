...
L.Control.Search = L.Control.extend({
	...
	_defaultFormatData: function(json) {	//default callback for format data to indexed data
		var self = this,
			propMagicKey = this.options.propertyMagicKey,
		...
		if (propMagicKey)
			for (let i in json)
				jsonret[ self._getPath(json[i],propName) ]= json[i][ propMagicKey ]+':'+json[i][ 'type' ];


		else if( L.Util.isArray(propLoc) )
			for (let i in json)
