        ...
        self.layout = Layout(
            Div(
                Div(
                    ...
                    Div("nalezce", css_class="col-sm-6 col-lg-2"),
                    Div("datum_nalezu", css_class="col-sm-6 col-lg-4 app-daterangepicker"),
                    Div("predano_organizace", css_class="col-sm-6 col-lg-2"),
                    Div("predano", css_class="col-sm-6 col-lg-2"),
                    ...
                    Div("specifikace", css_class="col-sm-6 col-lg-2"),
                    Div("okolnosti", css_class="col-sm-6 col-lg-2"),
                    Div("hloubka_od", css_class="col-sm-6 col-lg-2"),
