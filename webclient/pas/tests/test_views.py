...
class UrlTests(TestCase):
    def setUp(self):
        ...
        UserNotificationType(ident_cely='E-N-05', predmet="Test", cesta_sablony="emails/E-N-05.html").save()
        UserNotificationType(ident_cely='E-N-06', predmet="Test", cesta_sablony="emails/E-N-06.html").save()
