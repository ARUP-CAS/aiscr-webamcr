...
class NalezObjekt(ExportModelOperationsMixin("nalez_objekt"), models.Model):
    ...
    class Meta:
        """Zapouzdřuje chování třídy ``NalezObjekt.Meta`` pro modul ``webclient.nalez.models``."""
...
class NalezPredmet(ExportModelOperationsMixin("nalez_predmet"), models.Model):
    ...
    class Meta:
        """Zapouzdřuje chování třídy ``NalezPredmet.Meta`` pro modul ``webclient.nalez.models``."""
