    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dokument_cast', models.OneToOneField(blank=True, db_column='dokument_cast', on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='neident_akce', serialize=False, to='dokument.dokumentcast')),
