...
class NeidentAkce(ExportModelOperationsMixin("neident_akce"), models.Model):
    ...
    class Meta:
        """Zapouzdřuje chování třídy ``NeidentAkce.Meta`` pro modul ``webclient.neidentakce.models``."""
...
class NeidentAkceVedouci(ExportModelOperationsMixin("neident_akce_vedouci"), models.Model):
    ...
    class Meta:
        """Zapouzdřuje chování třídy ``NeidentAkceVedouci.Meta`` pro modul ``webclient.neidentakce.models``."""
