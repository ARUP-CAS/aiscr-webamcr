...
class AkceUzivatel(BaseSeleniumTestClass):
    """Zapouzdřuje chování třídy ``AkceUzivatel`` pro modul ``webclient.uzivatel.tests.test_selenium``."""
...
class AkceOrganizace(BaseSeleniumTestClass):
    """Zapouzdřuje chování třídy ``AkceOrganizace`` pro modul ``webclient.uzivatel.tests.test_selenium``."""
...
class AkceOsoba(BaseSeleniumTestClass):
    """Zapouzdřuje chování třídy ``AkceOsoba`` pro modul ``webclient.uzivatel.tests.test_selenium``."""
