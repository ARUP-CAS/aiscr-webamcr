...
FILE_IMPORT_FTP_HOSTNAME = get_secret("FILE_IMPORT_FTP_HOSTNAME", "")
FILE_IMPORT_FTP_USER_NAME = get_secret("FILE_IMPORT_FTP_USER_NAME", "")
FILE_IMPORT_FTP_PASSWORD = get_secret("FILE_IMPORT_FTP_PASSWORD", "")
FILE_IMPORT_FTP_PATH = get_secret("FILE_IMPORT_FTP_PATH", "")
