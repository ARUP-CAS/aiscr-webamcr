...
PAS_CONFIG = {
    ...
    "sections": {
        "popis_pas": {
            ...
            "geom": GeomGmlField(_("vypis.pas.popis_pas.geom.GML.label"), "geom"),
            "geom_sjtsk": GeomGmlField(_("vypis.pas.popis_pas.geom_sjtsk.GML.label"), "geom_sjtsk"),
            "geom_wkt": GeomWktField(_("vypis.pas.popis_pas.geom.WKT.label"), "geom"),
            "geom_sjtsk_wkt": GeomWktField(_("vypis.pas.popis_pas.geom_sjtsk.WKT.label"), "geom_sjtsk"),
        },
        "historie": {
