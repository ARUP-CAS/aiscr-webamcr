            ...
            state_operations=[
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        ("request_target", models.CharField(choices=[("samostatny_nalez_xml_import", "api.model.apiRequestLog.requestTarget.samostatnyNalezXmlImport")], max_length=64, verbose_name="api.model.apiRequestLog.requestTarget")),
