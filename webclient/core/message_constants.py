...
ZAZNAM_NELZE_SMAZAT_FEDORA = _(
    "common.message.ZAZNAM_NELZE_SMAZAT_FEDORA.text"
)  # Záznam nelze smazat, protože nebylo dokončeno nahrávání do Fedory..
ZAZNAM_USPESNE_VYTVOREN: Final = _("common.message.ZAZNAM_USPESNE_VYTVOREN.text")  # Záznam byl úspěšně vytvořen.
ZAZNAM_SE_NEPOVEDLO_VYTVORIT: Final = _(
    "common.message.ZAZNAM_SE_NEPOVEDLO_VYTVORIT.text"
)  # Záznam se nepovedlo vytvořit.
...
MAXIMUM_AKCII_DOSAZENO: Final = _(
    "common.message.MAXIMUM_AKCI_DOSAZENO.text"
)  # Byl překročen limit akcí pro jeden projekt.
...
PROJEKT_USPESNE_VRACEN: Final = _(
    "common.message.PROJEKT_USPESNE_VRACEN.text"
)  # Projekt byl úspěšně vrácen do předchozího stavu.
PROJEKT_USPESNE_SCHVALEN: Final = _("common.message.PROJEKT_USPESNE_SCHVALEN.text")  # Projekt byl úspěšně schválen.
PROJEKT_USPESNE_ZAHAJEN_V_TERENU: Final = _(
    "common.message.PROJEKT_USPESNE_ZAHAJEN_V_TERENU.text"
)  # Projekt byl úspěšně zahájen v terénu.
PROJEKT_USPESNE_UKONCEN_V_TERENU: Final = _(
    "common.message.PROJEKT_USPESNE_UKONCEN_V_TERENU.text"
)  # Projekt byl úspěšně ukončen v terénu.
...
PROJEKT_USPESNE_ARCHIVOVAN: Final = _(
    "common.message.PROJEKT_USPESNE_ARCHIVOVAN.text"
)  # Projekt byl úspěšně archivován.
PROJEKT_USPESNE_NAVRZEN_KE_ZRUSENI: Final = _(
    "common.message.PROJEKT_USPESNE_NAVRZEN_KE_ZRUSENI.text"
)  # Projekt byl úspěšně navržen ke zrušení.
PROJEKT_NELZE_UZAVRIT: Final = _(
    "common.message.PROJEKT_NELZE_UZAVRIT.text"
)  # Projekt nelze uzavřít. Zkontrolujte zda má všechny náležitosti.
PROJEKT_NELZE_ARCHIVOVAT: Final = _(
    "common.message.PROJEKT_NELZE_ARCHIVOVAT.text"
)  # Projekt nelze archivovat. Zkontrolujte zda má všechny náležitosti.
PROJEKT_NELZE_NAVRHNOUT_KE_ZRUSENI: Final = _(
    "common.message.PROJEKT_NELZE_NAVRHNOUT_KE_ZRUSENI.text"
...
DOKUMENT_USPESNE_ARCHIVOVAN: Final = _(
    "common.message.DOKUMENT_USPESNE_ARCHIVOVAN.text"
)  # Dokument úspěšně archivován.
DOKUMENT_USPESNE_VRACEN: Final = _("common.message.DOKUMENT_USPESNE_VRACEN.text")  # Dokument úspěšně vrácen.
DOKUMENT_SE_NEPODARILO_VRATIT: Final = _(
    "common.message.DOKUMENT_SE_NEPODARILO_VRATIT.text"
)  # Dokument se nepodařilo vrátit.
...
DOKUMENT_PROJEKT_USPESNE_PRIPOJEN: Final = _("core.message_constants.dokumentProjektUspesnePripojen.text")
...
DOKUMENT_NEIDENT_AKCE_USPESNE_SMAZANA: Final = _("core.message_constants.dokumentNeidentAkceUspesneSmazana.text")
# Osoba
...
# SN
SAMOSTATNY_NALEZ_VRACEN: Final = _(
    "common.message.SAMOSTATNY_NALEZ_VRACEN.text"
)  # Samostatný nález vrácen do předchozího stavu.
SAMOSTATNY_NALEZ_NELZE_ODESLAT: Final = _(
    "common.message.SAMOSTATNY_NALEZ_NELZE_ODESLAT.text"
)  # Samostatný nález nelze odeslat.
SAMOSTATNY_NALEZ_ODESLAN: Final = _("common.message.SAMOSTATNY_NALEZ_ODESLAN.text")  # Samostatný nález úspěšně odeslán.
SAMOSTATNY_NALEZ_POTVRZEN: Final = _(
    "common.message.SAMOSTATNY_NALEZ_POTVRZEN.text"
)  # Samostatný nález úspěšně potvrzen.
SAMOSTATNY_NALEZ_NELZE_POTVRDIT: Final = _(
    "common.message.SAMOSTATNY_NALEZ_NELZE_POTVRDIT.text"
)  # Samostatný nález nelze potvrdit.
SAMOSTATNY_NALEZ_ARCHIVOVAN: Final = _(
    "common.message.SAMOSTATNY_NALEZ_ARCHIVOVAN.text"
)  # Samostatný nález úspěšně archivován.
SAMOSTATNY_NALEZ_NELZE_ARCHIVOVAT: Final = _(
    "common.message.SAMOSTATNY_NALEZ_NELZE_ARCHIVOVAT.text"
)  # Samostatný nález nelze archivovat.
SAMOSTATNY_NALEZ_NEKDO_ZMENIL_STAV: Final = _("core.message_constants.pasZmenaStavuNekymJinym.text")

# Spoluprace
ZADOST_O_SPOLUPRACI_VYTVORENA: Final = _(
    "common.message.ZADOST_O_SPOLUPRACI_VYTVORENA.text"
)  # Žádost o spolupráci byla vytvořena.
...
LOKALITA_EO_USPESNE_PRIPOJEN: Final = _("core.message_constants.externiZdrojUspesnePripojenaLokalitaEO.text")
