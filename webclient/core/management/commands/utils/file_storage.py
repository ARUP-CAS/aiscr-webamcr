...
def save_single_file_from_storage_impl(
    ...
    :param record_par: Popis parametru `record_par`.
    :param storage_path: Popis parametru `storage_path`.
    :param save_thumbs: Popis parametru `save_thumbs`.
    :param disable_antivirus: Popis parametru `disable_antivirus`.
    """
