...
urlpatterns = [
    ...
    path("soubor/stahnout/<int:pk>", views.DownloadFile.as_view(), name="download_file"),
    path("soubor/stahnout-stahnout/<int:pk>", views.DownloadThumbnail.as_view(), name="download_thumbnail"),
