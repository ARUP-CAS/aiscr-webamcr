...
class RunDataImportLokalitaTest(TestCase):
    ...
    def test_delete_removes_az_and_lokalita_from_database(self):
        """DELETE pro ``LokalitaMapper`` smaže Lokalitu i ArcheologickyZaznam.
        ...
        delete_payload = {"__file_name": FILE_KEY, "ident_cely": LOK_IDENT}
        ...
        self.assertFalse(
            ...
            "DELETE musí smazat záznam Lokalita.",
        )
        self.assertFalse(
