...
class MyCronJobPianToJTSK(CronJobBase):
    ...
    code = "cron.job01.MyCronJobPianToSJTSK"  # a unique code
    ...
    def do(self):
        try:
            ...
            query_delete_jobs = "delete from public.amcr_geom_migrations_jobs where created_at<CURRENT_TIMESTAMP - INTERVAL '1' hour and count_selected_wgs84=0 and count_selected_sjtsk=0"
