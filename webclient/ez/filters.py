        ...
        self.layout = Layout(
            Div(
                Div(
                    ...
                    Div("autori", css_class="col-sm-6 col-lg-2"),
                    Div("editori", css_class="col-sm-6 col-lg-2"),
                    Div("typ_dokumentu", css_class="col-sm-6 col-lg-2"),
                    Div("organizace", css_class="col-sm-6 col-lg-2"),
                    Div("popisne_udaje", css_class="col-sm-12 col-lg-8"),
                    css_class="row",
                ),
                Div(
                ...
                Div(
                    Div("akce_ident", css_class="col-sm-6 col-lg-2"),
                    Div("lokalita_ident", css_class="col-sm-6 col-lg-2"),
                    id="SouvisCollapse",
                    css_class="collapse row",
                ),
            ),
