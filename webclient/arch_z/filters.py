        ...
        self.layout = Layout(
            Div(
                Div(
                    ...
                    Div("vedouci", css_class="col-sm-6 col-lg-2"),
                    Div("pristupnost", css_class="col-sm-6 col-lg-2"),
                    Div("katastr", css_class="col-sm-6 col-lg-2"),
                    Div("okres", css_class="col-sm-6 col-lg-2"),
                    Div("kraj", css_class="col-sm-6 col-lg-2"),
                    Div("popisne_udaje", css_class="col-sm-6 col-lg-4"),
                    Div("zahrnout_projektove", css_class="col-sm-6 col-lg-2"),
                    Div("datum_zahajeni", css_class="col-sm-6 col-lg-4 app-daterangepicker"),
                    Div("datum_ukonceni", css_class="col-sm-6 col-lg-4 app-daterangepicker"),
                    Div("has_positive_find", css_class="col-sm-6 col-lg-2"),
                    Div("je_nz", css_class="col-sm-6 col-lg-2"),
                    Div("odlozena_nz", css_class="col-sm-6 col-lg-2"),
                    css_class="row",
                ),
                Div(
                ...
                Div(
                    Div("dj_typ", css_class="col-sm-6 col-lg-2"),
                    Div("dj_nazev", css_class="col-sm-6 col-lg-2"),
                    Div("dj_zjisteni", css_class="col-sm-6 col-lg-2"),
                    Div("pian_ident_obsahuje", css_class="col-sm-6 col-lg-2"),
                    Div("pian_typ", css_class="col-sm-6 col-lg-2"),
                    Div("pian_presnost", css_class="col-sm-6 col-lg-2"),
                    id="DjPianCollapse",
                    css_class="collapse row",
                ),
                Div(
                ...
                Div(
                    Div("komponenta_obdobi", css_class="col-sm-6 col-lg-2"),
                    Div("komponenta_jistota", css_class="col-sm-6 col-lg-2"),
                    Div("komponenta_areal", css_class="col-sm-6 col-lg-2"),
                    Div("komponenta_aktivity", css_class="col-sm-6 col-lg-2"),
                    Div("komponenta_poznamka", css_class="col-sm-6 col-lg-4"),
                    ...
                    Div("objekt_pozn_pocet", css_class="col-sm-6 col-lg-4"),
                ...
                Div(
                    Div("adb_ident_obsahuje", css_class="col-sm-6 col-lg-2"),
                    Div("adb_typ_sondy", css_class="col-sm-6 col-lg-2"),
                    Div("adb_podnet", css_class="col-sm-6 col-lg-2"),
                    Div("adb_popisne_udaje", css_class="col-sm-6 col-lg-4"),
                    Div(css_class="col-sm-6 col-lg-2"),
                    Div("adb_autori", css_class="col-sm-6 col-lg-2"),
                    Div("adb_roky", css_class="col-sm-6 col-lg-4 app-daterangepicker"),
                    Div(css_class="col-sm-6 col-lg-6"),
                    Div("vb_ident_obsahuje", css_class="col-sm-6 col-lg-2"),
                    Div("vb_uroven", css_class="col-sm-6 col-lg-2"),
                    Div("vb_niveleta_od", css_class="col-sm-6 col-lg-2"),
                    Div("vb_niveleta_do", css_class="col-sm-6 col-lg-2"),
                    id="AdbCollapse",
                    css_class="collapse row",
                ),
                Div(
                ...
                Div(
                    Div("dokument_ident", css_class="col-sm-6 col-lg-2"),
                    Div("zdroj_ident", css_class="col-sm-6 col-lg-2"),
                    id="zaznamyCollapse",
                    css_class="collapse row",
                ),
            ),
