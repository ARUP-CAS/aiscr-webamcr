...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Akce',
            fields=[
                ('typ', models.CharField(blank=True, choices=[('R', 'Projektova'), ('N', 'Samostatna')], max_length=1, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archeologicky_zaznam', models.ForeignKey(blank=True, db_column='archeologicky_zaznam', on_delete=django.db.models.deletion.CASCADE, related_name='externi_odkazy', to='arch_z.archeologickyzaznam')),
            ],
            options={
