...
class AkceTestClass(BaseSeleniumTestClass):
    """Zapouzdřuje chování třídy ``AkceTestClass`` pro modul ``webclient.arch_z.tests.test_selenium``."""
    __test__ = False
...
class AkceProjektoveAkce(AkceTestClass):
    """Zapouzdřuje chování třídy ``AkceProjektoveAkce`` pro modul ``webclient.arch_z.tests.test_selenium``."""
