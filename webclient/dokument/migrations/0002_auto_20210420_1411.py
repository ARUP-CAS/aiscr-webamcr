...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('arch_z', '0003_auto_20210420_1411'),
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='dokumentcast',
            name='komponenty',
            field=models.OneToOneField(blank=True, db_column='komponenty', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='komponenta.komponentavazby'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='dokument',
            name='posudky',
            field=models.ManyToManyField(limit_choices_to={'nazev_heslare': 21}, related_name='dokumenty_posudku', through='dokument.DokumentPosudek', to='heslar.Heslar'),
        ),
        migrations.AddField(
            model_name='dokument',
            name='pristupnost',
        ...
        migrations.AddField(
            model_name='dokument',
            name='soubory',
            field=models.ForeignKey(db_column='soubory', on_delete=django.db.models.deletion.DO_NOTHING, to='core.souborvazby'),
        ),
        migrations.AddField(
            model_name='dokument',
            name='typ_dokumentu',
