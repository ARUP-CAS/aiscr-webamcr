...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='let',
            name='pocasi',
            field=models.ForeignKey(db_column='pocasi', limit_choices_to={'nazev_heslare': 19}, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='let_pocasi', to='heslar.heslar'),
        ),
        migrations.AddField(
            model_name='let',
            name='pozorovatel',
