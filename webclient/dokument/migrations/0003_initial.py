...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='dokumentcast',
            constraint=models.CheckConstraint(condition=models.Q(('archeologicky_zaznam__isnull', False), ('projekt__isnull', False), _negated=True), name='dokument_cast_vazba_check'),
        ),
        migrations.AddConstraint(
            model_name='dokumentextradata',
            constraint=models.CheckConstraint(condition=models.Q(('duveryhodnost__gte', 0), ('duveryhodnost__lte', 100)),
