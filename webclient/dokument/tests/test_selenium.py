...
class AkceDokumenty(BaseSeleniumTestClass):
    ...
    def test_141_test_Fedory_dokument_p_001(self):
        ...
        self.driver.find_element(By.CSS_SELECTOR, ".select2-search__field").send_keys("C")
        self.driver.find_element(By.CSS_SELECTOR, ".select2-search__field").send_keys(Keys.ENTER)
        with WaitForPageLoad(self.driver):
            self.ElementClick(By.ID, "submit-btn")
        ...
        self.driver.find_element(By.CSS_SELECTOR, ".modal-body > #div_id_poznamka #id_poznamka").send_keys("test")
        with WaitForPageLoad(self.driver):
            self.ElementClick(By.ID, "submit-btn")
        ...
        self.driver.find_element(By.CSS_SELECTOR, ".row:nth-child(10) #id_popis").send_keys("test")
        self.ElementClick(By.CSS_SELECTOR, ".row:nth-child(10) #id_poznamka")
        self.driver.find_element(By.CSS_SELECTOR, ".row:nth-child(10) #id_poznamka").send_keys("test1")
        with WaitForPageLoad(self.driver):
            self.ElementClick(By.ID, "submit-btn")
    ...
    def test_142_test_Fedory_LET_p_001(self):
        ...
        time = self.getTime()
        self.ElementClick(By.ID, "id_ident_cely")
        self.driver.find_element(By.ID, "id_ident_cely").send_keys("C-LET-00413")
        self.ElementClick(By.ID, "id_uzivatelske_oznaceni")
        self.driver.find_element(By.ID, "id_uzivatelske_oznaceni").send_keys("test")
        self.ElementClick(By.ID, "id_datum")
        self.driver.find_element(By.ID, "id_datum").send_keys("08.06.2025 ")
        self.ElementClick(By.ID, "id_pilot")
        self.driver.find_element(By.ID, "id_pilot").send_keys("Havrlant")
        self.ElementClick(By.CSS_SELECTOR, "#id_pozorovatel > option:nth-child(33)")
        self.ElementClick(By.ID, "id_ucel_letu")
        self.driver.find_element(By.ID, "id_ucel_letu").send_keys("Vyhlídkový")
        self.ElementClick(By.ID, "id_typ_letounu")
        self.driver.find_element(By.ID, "id_typ_letounu").send_keys("Blaník")
        ...
        self.driver.find_element(By.ID, "id_hodina_zacatek").send_keys("10")
        self.ElementClick(By.ID, "id_hodina_konec")
        self.driver.find_element(By.ID, "id_hodina_konec").send_keys("11")
        ...
        self.driver.find_element(By.ID, "id_fotoaparat").send_keys("nic")
        ...
        self.driver.find_element(By.ID, "id_ident_cely").send_keys("C-LET-00414")
        with WaitForPageLoad(self.driver):
            self.ElementClick(By.NAME, "_save")
...
class AkceKnihovna3D(BaseSeleniumTestClass):
    ...
    def test_144_test_Fedory_3D_p_001(self):
        ...
        self.ElementClick(By.ID, "buttonEdit")
        self.ElementClick(By.ID, "id_popis")
        self.driver.find_element(By.ID, "id_popis").send_keys("test1")
        self.ElementClick(By.CSS_SELECTOR, "#div_id_format .btn")
        self.ElementClick(By.CSS_SELECTOR, "#bs-select-3-1 > .text")
        with WaitForPageLoad(self.driver):
            self.ElementClick(By.ID, "newDocumentSubmitBtn")
