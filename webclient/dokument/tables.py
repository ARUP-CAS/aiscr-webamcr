...
class DokumentTable(SearchTable):
    ...
    extra_data__datum_vzniku = tables.Column(verbose_name=_("dokument.tables.dokumentTable.extra_data__datum_vzniku.label"))
    extra_data__cislo_objektu = tables.Column(verbose_name=_("dokument.tables.dokumentTable.extra_data__cislo_objektu.label"))
    extra_data__format = tables.Column(verbose_name=_("dokument.tables.dokumentTable.extra_data__format.label"))
    extra_data__zachovalost = tables.Column(verbose_name=_("dokument.tables.dokumentTable.extra_data__zachovalost.label"))
    extra_data__nahrada = tables.Column(verbose_name=_("dokument.tables.dokumentTable.extra_data__nahrada.label"))
    extra_data__pocet_variant_originalu = tables.Column(verbose_name=_("dokument.tables.dokumentTable.extra_data__pocet_variant_originalu.label"))
    ...
    extra_data__duveryhodnost = tables.Column(verbose_name=_("dokument.tables.dokumentTable.extra_data__duveryhodnost.label"))
    columns_to_hide = (
        "pristupnost",
        "datum_zverejneni",
        "oznaceni_originalu",
