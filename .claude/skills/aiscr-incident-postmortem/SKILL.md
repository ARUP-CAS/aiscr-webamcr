...
- Canonical reader: [`.cursor/skills/aiscr-incident-postmortem/SKILL.md`](.cursor/skills/aiscr-incident-postmortem/SKILL.md). Read that file before executing this workflow or when the workflow body is load-bearing.
...
Load [`.cursor/skills/aiscr-incident-postmortem/SKILL.md`](.cursor/skills/aiscr-incident-postmortem/SKILL.md) for the full workflow body, guardrails, implementation steps, and verification requirements.
